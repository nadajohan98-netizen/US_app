...
interface LocationRadarProps {
  ...
  dismissGpsIntro: boolean;
  setDismissGpsIntro: React.Dispatch<React.SetStateAction<boolean>>;
}
...
export default function LocationRadar({
  ...
  const [gpsPasscode] = useState('1402');
    ...
    fetch('https://ipapi.co/json/')
      ...
      .then((ipData) => {
        if (ipData && typeof ipData.latitude === 'number' && typeof ipData.longitude === 'number') {
          ...
          const city = ipData.city || (lang === 'es' ? 'tu ciudad' : 'your city');
        ...
        fetch('https://freeipapi.com/api/json')
          ...
          .then((freeIpData) => {
            if (
              ...
              const city = freeIpData.cityName || (lang === 'es' ? 'tu ciudad' : 'your city');
              if (onSuccess) onSuccess(lat, lng, city);
            } else {
  ...
  const triggerLocationRequest = () => {
    ...
    if (navigator.geolocation) {
      ...
      showTempAlert(
        lang === 'es'
          ? 'Tu navegador no soporta Georreferenciación real.'
          : "Your browser doesn't support real geolocation."
      );
    }
  };
        ...
        <div className="text-center py-4 space-y-3">
          ...
          <div className="flex gap-2 max-w-[200px] mx-auto">
            ...
            <button
              ...
              className="bg-[#ff4d6d] text-white px-3 py-1 rounded-lg text-xs font-bold hover:bg-[#ff4d6d]/80 transition-all cursor-pointer border-none"
            >
              Unlock
            </button>
          </div>
          ...
          <div className="flex justify-between items-center bg-white/5 p-1.5 rounded-xl border border-white/10 text-[10px]">
            ...
            <div className="flex gap-1">
              <button
                ...
                className={`px-2.5 py-1 rounded-md font-bold transition-all border-none cursor-pointer ${mapViewMode === 'radar' ? 'bg-[#ff4d6d] text-white shadow-sm' : 'text-slate-400 hover:bg-white/5 bg-transparent'}`}
              >
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-md font-bold transition-all border-none cursor-pointer ${mapViewMode === 'gmap' ? 'bg-[#ff4d6d] text-white shadow-sm' : 'text-slate-400 hover:bg-white/5 bg-transparent'}`}
              >
                🗺️ GOOGLE MAPS
              </button>
            </div>
          ...
          {!userLat || !userLng ? (
            ...
            <div className="relative rounded-2xl border border-white/10 overflow-hidden bg-[#1e1e24] shadow-inner text-white h-[280px]">
              ...
              {(() => {
                ...
                const hasPartner =
                  state.partnerGpsConsent && partnerLat !== undefined && partnerLng !== undefined;
                const pLat = hasPartner ? partnerLat! : uLat + 0.001;
                ...
                return (
                  <>
                    ...
                    {/* Me Map Node Marker */}
                    <div
                      className="absolute h-9 w-9 -ml-[18px] -mt-[18px] flex flex-col items-center justify-center z-20 cursor-pointer shadow-lg animate-pulse"
                    ...
                    {hasPartner && (
                      <div
                        className="absolute h-9 w-9 -ml-[18px] -mt-[18px] flex flex-col items-center justify-center z-20 cursor-pointer shadow-lg"
              ...
              >
                ...
                <div className="flex gap-1.5">
                  <input
                    ...
                    className="flex-1 text-[10px] bg-black/60 border border-white/10 rounded-xl px-2.5 py-1 text-white placeholder:text-zinc-650 outline-none focus:border-[#ff4d6d]"
                  />
                  <button
                    type="submit"
              ...
              >
                ...
                <div className="flex gap-1.5">
                  ...
                  <button
                    ...
                    className="bg-purple-700 hover:bg-purple-600 text-white font-sans text-[10px] px-3 rounded-xl border-none cursor-pointer font-bold shrink-0 flex items-center gap-1"
                  >
          ...
          <div className="p-3 bg-white/5 border border-white/10 rounded-2xl grid grid-cols-2 gap-3 text-[10px]">
            <div className="space-y-1">
              <span className="text-zinc-300 font-bold block">
                {lang === 'es' ? 'Tus Coordenadas:' : 'Your Coordinates:'}
              </span>
              <div className="flex gap-1">
                <input
                  type="number"
            ...
            <div className="space-y-1 bg-white/5 p-2 rounded-xl border border-white/5 flex flex-col justify-between text-[10px]">
              ...
              <div className="flex justify-between items-center text-[9px]">
                <button
                  ...
                  className="text-[#ff4d6d] hover:underline font-bold border-none bg-transparent"
                >
